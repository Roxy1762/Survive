...
本设计文档描述了《尘埃与回响》游戏的核心功能修复，包括：
1. **T1地图访问修复** - 无电塔时也能探索近郊区域
2. **岗位系统改进** - 基础岗位无需建筑即可工作，建筑提供效率加成
3. **建筑功能完善** - 建筑提供岗位槽位和效率加成
4. **探索功能修复** - 确保探索正确执行并产生结果
5. **AU自动进阶** - 支持自动推进游戏阶段

这些修复旨在解决早期游戏的资源死锁问题，确保游戏核心循环正常运作。
